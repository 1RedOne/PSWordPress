...
$results.posts | 
select ID,@{n='Author';Exp={$_.author.Name}},date,@{n='title';Exp={[System.Web.HttpUtility]::HtmlDecode($_.title) -join ''}},status,URL,short_URL,@{n='Activity(Comments)';Exp={$_.Discussion.Comment_Count}}
